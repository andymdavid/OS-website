    ...
    <section className="intro-section">
      <div className="intro-container">
        ...
        <p className="intro-text fade-in fade-in-stagger-2">
          Many of us still think AI is only for programmers, or just a fancy Google search.
        </p>

        <p className="intro-text fade-in fade-in-stagger-3">
          We feel like we're not technical enough, or it's too confusing to know where to begin. You're not the only one, most people are trying to make sense of this too.
        </p>

        <p className="intro-text fade-in fade-in-stagger-4">
        ...
        <p className="intro-text intro-text-emphasis fade-in fade-in-stagger-5">

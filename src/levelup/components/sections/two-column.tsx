                ...
                <div className="w-full flex flex-row gap-4 items-start justify-center md:justify-start flex-wrap">
                  {splitRightBlocks.map((block, index) => (
                    ...
                    >
                      ...
                      {block.showSocialButtons ? (
                        <div
                          className="levelup-bio-card-social mt-4"
                          aria-label={`${block.title} social links`}
                        >
                          <a
                            href={block.socialLinks?.linkedin || "#"}
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label={`${block.title} LinkedIn`}
                          >
                          ...
                          <a
                            href={block.socialLinks?.primal || "#"}
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label={`${block.title} Primal`}
                          >
                            <img
                              src="/primal-logo-white.svg"
                              alt=""
                              aria-hidden="true"
                              className="levelup-bio-card-social-primal"
                            />
                          </a>
                        </div>
                      ) : null}
        ...
        <Container>
          ...
          >
            ...
            <p
              ...
              style={{ whiteSpace: "pre-line", paddingBottom: "1.75rem", maxWidth: "46rem" }}
            >
              {renderBody()}
            </p>

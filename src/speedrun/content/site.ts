    ...
    },
    {
      ...
      props: {
        ...
        blocks: [
          {
            number: "01",
            title: "Build practical experience and strategy will follow.",
            body: "It’s difficult to build an AI strategy without first understanding what AI can do inside your business. Speedrun provides that understanding by having you build and modify a working business tool with AI during the session.",
          },
          {
            number: "02",
            title: "Build lasting internal AI capability",
            body: "When people inside the business start building and experimenting themselves, decisions improve about where and how AI genuinely adds value.",
          },
          {
            number: "03",
            title: "Learn by applying AI to your own work",
            body: "Speedrun creates the space to work hands-on with AI, so you can see what works, what doesn’t, and where it genuinely adds value.",
          },
          {
            number: "04",
            title: "Building creates clarity quickly",
            body: "Building real tools with AI develops practical skills quickly, giving your team the clarity to see where it genuinely fits and adds value.",
          },
        ],
      },
    },
        ...
        levelUpCards: [
          {
            id: "1",
            number: "01",
            title: "Orientation and Start Building",
            description: "You’re introduced to the tools and the goal of the session, then quickly move into building. Everyone gets something working early, so the focus stays on understanding behaviour rather than setting things up.",
            primaryTag: "15 mins",
            secondaryTag: "Guided",
            summaryItems: [
              { number: "01", text: "Clarify the business problem you’ll work on" },
              { number: "02", text: "Get a working tool on screen quickly" },
            ],
          },
          {
            id: "2",
            number: "02",
            title: "Shape the Tool with AI Agents",
            description: "You use AI coding agents to modify your app as it’s being built. You change stages, add fields, and adjust how tasks move and update. Each change is made in plain language and immediately reflected on screen, so you can see how instructions turn into working features.",
            primaryTag: "30 mins",
            secondaryTag: "Hands-on",
            summaryItems: [
              { number: "01", text: "Tell the app what to do and run it" },
              { number: "02", text: "Use AI to build and modify the tool" },
            ],
          },
          {
            id: "3",
            number: "03",
            title: "Test, Adjust, and Learn",
            description: "You run what you’ve built, see where it behaves as expected and where it doesn’t, and make adjustments. This is where understanding really forms, as cause and effect become visible in your own work.",
            primaryTag: "30 mins",
            secondaryTag: "Iterate",
            summaryItems: [
              { number: "01", text: "Run the tool and see how it behaves" },
              { number: "02", text: "Refine based on real outcomes" },
            ],
          },
          {
            id: "4",
            number: "04",
            title: "Step back and make sense of it",
            description: "The session closes by reflecting on what you’ve built, how the system works, and what that means for your business. This is where insights about fit, limitations, and next steps tend to surface.",
            primaryTag: "15 mins",
            secondaryTag: "Reflect",
            summaryItems: [
              { number: "01", text: "Understand what works and what doesn’t" },
              { number: "02", text: "Identify where this might fit in your business" },
            ],
          },
        ],
      },
